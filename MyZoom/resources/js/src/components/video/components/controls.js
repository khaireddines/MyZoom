                ...
                <div>
                    <div className="headerWrapper-3NUKsd">
                        <section className="theme-dark container-1r6BKw transparent-2ZlE3R">
                            ...
                            <span type="button" style={{cursor: 'pointer',position: 'absolute',top: '1rem',right: '7rem'}} onClick={RecordVideo}> <VideoCameraOutlined style={iconStyle} /></span>
                            <span type="button" style={{cursor: 'pointer',position: 'absolute',top: '1rem',right: '5rem'}} onClick={RecordShareScreen}> <FundViewOutlined style={iconStyle} /></span>
                            <span type="button" style={{cursor: 'pointer',position: 'absolute',top: '0rem',right: '1rem'}} onClick={StartRecord}>
                                <span className="anticon anticon-video-camera" style={{fontSize: '50px'}}>
